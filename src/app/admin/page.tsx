...
export default function AdminDashboard() {
  // إضافة ساعة حية لإعطاء طابع "مركز تحكم تقني وعلمي"
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="w-full md:w-2/3">
            ...
            <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-xl leading-relaxed">
              Eşgili Restoran'ın dijital komuta merkezindesiniz. Tüm operasyonları buradan bilimsel bir kesinlikle yönetebilirsiniz.
            </p>
          </div>
