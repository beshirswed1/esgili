            ...
            <div className="mt-8 flex flex-col gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">0501 000 19 27</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Yaprak, Kep Kep Sk. No:4 D:A, 27080 Şehitkamil/Gaziantep
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 rounded-xl bg-card border border-border p-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">08:00 - 22:30</p>
                </div>
              </div>
            </div>
          </div>
