...
import { Phone, MapPin, Clock, Link2, LucideUnlink, LucideCheckCircle2, LucideMoveRight } from "lucide-react"
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <span className="pl-6">{info.phone || "0501 000 19 27"}</span>
              </a>
              <a
                href={info.address || "https://maps.app.goo.gl/zqGDY2UEZAL1cGiCA"}
                target="_blank"
              ...
              >
                ...
                <span className="pl-6 leading-relaxed">Yaprak, Kep Kep Sk. No:4 D:A, 27080 Şehitkamil/Gaziantep</span>
              </a>
              <div className="flex flex-col gap-1 text-sm text-primary-foreground/70">
                ...
                <span className="pl-6">08:00 - 22:30</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://www.instagram.com/esgilirestoran/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-primary-foreground/5 border border-primary-foreground/10 hover:bg-primary hover:border-primary text-primary-foreground hover:text-foreground transition-all duration-300 hover:-translate-y-1" aria-label="Instagram">
                <FontAwesomeIcon icon={faInstagram} className="w-4 h-4" />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61567396096119" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-primary-foreground/5 border border-primary-foreground/10 hover:bg-primary hover:border-primary text-primary-foreground hover:text-foreground transition-all duration-300 hover:-translate-y-1" aria-label="Facebook">
                <FontAwesomeIcon icon={faFacebook} className="w-4 h-4" />
              </a>
              <a href="https://www.tiktok.com/@esgilirestoran" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-primary-foreground/5 border border-primary-foreground/10 hover:bg-primary hover:border-primary text-primary-foreground hover:text-foreground transition-all duration-300 hover:-translate-y-1" aria-label="TikTok">
                <FontAwesomeIcon icon={faTiktok} className="w-4 h-4" />
              </a>
              <a href="https://www.youtube.com/@esgilirestoran" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-primary-foreground/5 border border-primary-foreground/10 hover:bg-primary hover:border-primary text-primary-foreground hover:text-foreground transition-all duration-300 hover:-translate-y-1" aria-label="YouTube">
                <FontAwesomeIcon icon={faYoutube} className="w-4 h-4" />
              </a>
              <a href="mailto:esgilirestoran@gmail.com" className="flex items-center justify-center w-10 h-10 rounded-full bg-primary-foreground/5 border border-primary-foreground/10 hover:bg-primary hover:border-primary text-primary-foreground hover:text-foreground transition-all duration-300 hover:-translate-y-1" aria-label="Email">
                <FontAwesomeIcon icon={faEnvelope} className="w-4 h-4" />
              </a>
              <a href={`https://wa.me/${info.whatsapp || "905010001927"}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-primary-foreground/5 border border-primary-foreground/10 hover:bg-primary hover:border-primary text-primary-foreground hover:text-foreground transition-all duration-300 hover:-translate-y-1" aria-label="WhatsApp">
        ...
        <div className="mt-16 border-t border-primary-foreground/10 pt-8 flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-primary-foreground/50 text-center sm:text-left">
              © {new Date().getFullYear()} Eşgili Restoran. Tüm hakları saklıdır.
            </p>
          ...
          {/* Developer Credit - إعلان المبرمج بشير */}
          {/* Developer Credit - نسخة الـ Pro الأسطورية */}
          <div className="flex items-center justify-center pt-5 sm:pt-6 mt-16 border-t border-primary/10 px-4">
            <p className="text-sm text-primary-foreground/70 text-center leading-relaxed flex items-center gap-2.5 flex-wrap justify-center">
              ...
              {/* شارة المبرمج بشير - نسخة الـ Pro */}
              <a
              ...
              >
                ...
                {/* أيقونة الـ Pro الموثقة باللون الذهبي */}
                <LucideCheckCircle2 className="w-4 h-4 text-yellow-400 drop-shadow-sm" />

                {/* أيقونة الانتقال مع حركة عند الهوفر */}
