      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className={`mb-12 text-center ${visible ? "animate-fade-in-up" : "opacity-0"}`}>
          ...
          <div className={`mt-6 inline-flex items-center gap-4 rounded-2xl bg-card border border-border px-6 py-4 shadow-lg transition-all duration-500 hover:shadow-xl hover:scale-105 ${visible ? "animate-scale-in delay-200" : "opacity-0"
            ...
            <span className="text-5xl font-bold gradient-text">4.7</span>
        ...
        <div className={`mt-8 text-center ${visible ? "animate-fade-in-up delay-600" : "opacity-0"}`}>
          <a
            href="https://www.google.com/maps/place/E%C5%9Fgili+Restoran+%7C+Y%C3%B6resel+Gaziantep+Yemekleri/@37.0678276,37.3822789,18z/data=!3m1!4b1!4m6!3m5!1s0x1531e1581e7ae335:0xe6e9b5229f1620b4!8m2!3d37.0678255!4d37.3809914!16s%2Fg%2F11wr3b5lk2!18m1!1e1?entry=ttu&g_ep=EgoyMDI2MDMyMi4wIKXMDSoASAFQAw%3D%3D"
            target="_blank"
